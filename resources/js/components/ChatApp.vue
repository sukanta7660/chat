<template>
	<dir id="chatapp">
		<div class="container-chat clearfix">
			...
			<div class="chat" v-if="userMessage.messages">
					...
					<ul class="nav nav-tabs">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a @click.prevent="deleteAllMessage()" class="dropdown-item" href="#">Delete All Messages</a>
				...
				<div class="chat-history"  v-chat-scroll>
					<ul>
						<li v-for="message in userMessage.messages" :key="message.id" class="clearfix">
							<div class="message-data align-right">
								...
								<ul class="nav nav-tabs">
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdown">
											<a class="dropdown-item" @click.prevent="deleteSingleMessage(message.id)" href="#">Delete Message</a>
